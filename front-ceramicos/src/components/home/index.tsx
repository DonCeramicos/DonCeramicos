...
export const HomeComponent = () => {
  return (
    <div id="home" className="h-[100vh] md:h-[91vh] relative z-0 flex flex-col justify-center scroll-mt-24">
      ...
      <div className="absolute inset-0 grid grid-cols-2 grid-rows-2 z-0">
        ...
        <div
          ...
          style={{ backgroundImage: "url(/background-app.jpg)", transform: "rotate(180deg)", transformOrigin: "center center" }}
        ></div>
        <div className="bg-custom"></div>
      </div>
      ...
      <div className="relative z-10 flex flex-col gap-6 translate-y-12 md:translate-y-14">
        <h1
          style={{ color: "#a93737" }}
          className="font-poiret-one text-6xl w-[24rem] text-left mx-12 font-bold md:text-[8.7rem] md:w-[46rem] md:mx-1"
        >
          DON CERAMICOS
        </h1>
