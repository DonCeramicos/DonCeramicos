    ...
    <footer className={`w-full h-full z-60 relative flex flex-nowrap justify-center gap-6 md:flex-row md:justify-evenly ${path === '/catalogo' ? 'bg-black' : 'bg-custom-5'} color-font-2 py-3 px-4 font-phudu text-[12px]`}>
      ...
      <section className="flex flex-col gap-2 w-[45%] min-w-[140px] max-w-[240px] items-left md:items-center order-3">
        ...
        <div className="flex gap-4">
          <a aria-label="facebook" href="https://www.facebook.com/p/Don-cer%C3%A1micos-100068413961241" target="_blank" rel="noopener noreferrer">
            <img src="/facebook.png" alt="facebook" className="h-6 w-6 hover:scale-110 transition" />
          </a>
          <a aria-label="instagram" href="https://www.instagram.com/reel/DCCDuEYOjtj/" target="_blank" rel="noopener noreferrer">
            <img src="/instagram.png" alt="instagram" className="h-6 w-6 hover:scale-110 transition border-1 border-amber-50 rounded-full" />
          </a>
          <a aria-label="whatsapp" href="https://wa.me/+5491128254000?text=Hola!%20Quiero%20hacer%20una%20consulta" target="_blank" rel="noopener noreferrer">
            <img src="/whatsapp.png" alt="whatsapp" className="h-6.5 w-6.5 hover:scale-110 transition " />
          </a>
        </div>
      </section>
      ...
      <section className="flex flex-col gap-2 w-[45%] min-w-[140px] max-w-[240px]  items-center md:items-center text-center md:text-left order-2">
        ...
        >
          ...
          <p className="text-right md:text-center w-full">a 100 mts de la Estación Claypole, PBA</p>
        </a>
      </section>
