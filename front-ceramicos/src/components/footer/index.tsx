export const Footer = () => {
  return (
    <footer className="w-full h-full z-60 relative flex flex-wrap justify-center gap-6 md:flex-row md:justify-evenly bg-custom-5 color-font-2 py-3 px-4 font-phudu text-[12px]">
