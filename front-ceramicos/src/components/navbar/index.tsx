...
export const Navbar = () => {
  ...
  return (
    <nav className="bg-custom-2 sticky top-0 z-50 flex justify-evenly items-center px-4 py-1">
      ...
      >
        {isOpen ? (
          ...
          <svg aria-label="Abrir menú" className="w-8 h-8" fill="none" stroke="black" viewBox="0 0 24 24">
      ...
      {isOpen && (
        <div
          className="fixed inset-0 bg-amber-900/90 flex flex-col items-center justify-center gap-8 text-white text-2xl font-phudu z-40 transition-all duration-300"
          role="dialog"
          aria-modal="true"
        >
          ...
          <a aria-label="Ir al catálogo" href="#catalogo" onClick={toggleMenu} className="hover:scale-105 transition-all duration-300">
            CATALOGO
          </a>
          <a aria-label="Ir a las ofertas" href="#ofertas" onClick={toggleMenu} className="hover:scale-105 transition-all duration-300">
            OFERTAS
          </a>
